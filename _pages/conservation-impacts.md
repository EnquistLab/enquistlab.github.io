...
<figure class="field-photo" style="max-height:340px;">
  <img src="{{ '/assets/img/wordpress/sparc_overview_map.jpg' | relative_url }}" alt="SPARC conservation planning map showing priority regions for protected-area design across the Americas" loading="lazy" style="height:340px;object-fit:contain;background:#f7f6f2;">
  <figcaption>Decision-facing conservation planning: SPARC integrates biodiversity data, climate scenarios, and prioritization workflows to identify protected-area opportunities across the Americas.</figcaption>
</figure>
