...
<div style="text-align:center;margin:1.2rem 0;">
  <img src="https://nsojournals.onlinelibrary.wiley.com/cms/asset/27238c80-37d0-43de-b0e4-198d4d6c9b27/ecog13236-fig-0002-m.jpg"
       alt="TransPlant network — 22 elevation gradients across the Northern Hemisphere (Bektas et al. 2024, Ecography Fig. 2)"
       style="max-width:100%;border-radius:4px;">
  <p style="font-size:0.82rem;color:var(--global-text-color-light,#888);margin-top:0.4rem;">
    <strong>Fig. 1.</strong> The TransPlant Network: 22 elevation gradients across 20 mountainous regions of the Northern Hemisphere (A), and climatic position of origin (triangles) vs. destination (circles) sites in summer temperature — annual PET space (B). Panel colors indicate gradient; arrows show the direction of transplantation. Source: <a href="https://nsojournals.onlinelibrary.wiley.com/doi/10.1111/ecog.07378" target="_blank" rel="noopener">Bektas et al. 2024, <em>Ecography</em></a>.
  </p>
</div>
...
The [**Andes Biodiversity and Ecosystems Research Group (ABERG)**](https://www.andesconservation.org/) is an international research consortium led by [Miles Silman](https://bio.wfu.edu/faculty-and-staff/miles-silman/) (Wake Forest University) dedicated to understanding how biodiversity, ecosystem function, and carbon stocks vary across one of the world's most extraordinary mountain environments. Working through the [Amazon Conservation Association](https://www.andesconservation.org/) and its network of permanent field stations, ABERG coordinates long-term biological inventories, process-based ecosystem monitoring, and conservation-relevant research across the eastern Andean slope of southern Peru. The core study area — the Kosñipata Valley in Madre de Dios / Cusco, within and adjacent to **Manu National Park and Biosphere Reserve** — spans nearly 3,500 m of elevation from lowland Amazonian forest (~400 m) through lower and upper montane cloud forest to puna grasslands (~3,800 m), traversing one of the steepest environmental and biodiversity gradients on Earth. The ABERG research community brings together ecologists, taxonomists, remote sensing scientists, and biogeochemists from universities across Peru, Europe, and North America. Brian Enquist's lab at the University of Arizona is a long-standing core research partner, contributing trait-based, macroecological, and scaling analyses across the gradient.

#### CHAnging Montane Biodiversity And Structure Along the Andes (CHAMBASA)
