#################################################
#
# Brian Enquist's copy with annotation and edits
#
#
#
#################################################
...
setwd("/Users/brianjenquist/GitHub/R/enquistlab.github.io")
...
cannabis_sativa<-readShapePoly("/Users/brianjenquist/GitHub/R/enquistlab.github.io/GIS/plant_examples/Cannabis_sativa.shp")#obviously you'll need to change this a bit for your computer
...
acer_rubrum<-readShapePoly("/Users/brianjenquist/GitHub/R/enquistlab.github.io/GIS/plant_examples/acer_rubrum.shp")
#let's add this one
...
load("/Users/brianjenquist/GitHub/R/enquistlab.github.io/GIS/plant_examples/cannabis_sativa_occurrences")
...
#raster data: climate
bioclim1<-raster("/Users/brianjenquist/GitHub/R/enquistlab.github.io/GIS/bio_10m_bil/bio1.bil")
...
caecillians<-readShapePoly("/Users/brianjenquist/GitHub/R/enquistlab.github.io/GIS/GYMNOPHIONA/GYMNOPHIONA.shp")

#These shapefile have more species associated with them and more metadata, lets take a look!
str(caecillians)  #these are not plants right?!
